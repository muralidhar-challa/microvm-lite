...
var BINARIES = ["busybox", "mytool", "probe", "app", "runner"];
...
// M3 HTTP bridge: virtual IP → hostname (mirrors the v86 host's vmRoutes). The
...
self.Module = {
  ...
  // to raw HTTP response bytes. Routing mirrors the v86 host: every known
