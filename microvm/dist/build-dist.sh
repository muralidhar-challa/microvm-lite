...
#   dist/bin/{busybox,mytool,app,runner}       — core guest tools (eager)
...
for b in busybox mytool app runner; do cp -L "$WASM/$b" "$OUT/bin/$b"; done
...
for b in ["busybox", "mytool", "app", "runner"]:
