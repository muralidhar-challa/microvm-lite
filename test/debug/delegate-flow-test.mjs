...
log("== Init() verbatim ==");
log("  " + await run("[ -f /tmp/.mvl_boot ] || { uuidgen > /home/user/.session_id; : > /tmp/.mvl_boot; }"));
const sessionId = await run("cat /home/user/.session_id");
log("  session_id: " + sessionId);
const workdir = `/tmp/session_${sessionId}`;
