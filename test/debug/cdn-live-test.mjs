...
// URL — exactly what the host app's real the host integration hook does for this same
...
await check("home dir", "pwd", "/home/user");
...
await check("guestcli auto-staged + runs", "guestcli --help 2>&1 | head -c1 && echo x", null);
...
await check("CLAUDE.md seeded", "test -f /home/user/CLAUDE.md && echo YES", "YES");
await check("skills seeded", "ls /home/user/skills | wc -l", null);
